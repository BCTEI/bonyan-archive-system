...
> ⚠️ تُنشأ هذه البيانات مرة واحدة عند أول تشغيل فقط ولا تُعاد تهيئتها تلقائيًا. يجب تغيير كلمة المرور الافتراضية فور أول تسجيل دخول — بعد تغييرها لن تعمل `admin123`.
...
- **v1.2.0** — تأمين مسح سجل التدقيق + تقارير الطباعة + القوائم الرئيسية + تذييل النظام
- **v1.1.0** — النسخة المعتمدة السابقة (الجرد السنوي + مستويات السرية + أنواع الوثائق الديناميكية + إدارة التصنيفات)
- **v1.0.0** — النسخة الأولى (الوثائق والمستخدمين والتدقيق)

## النظام

يتضمن التطبيق تذييلًا ثابتًا في جميع الشاشات الرئيسية يعرض:

- **الحقوق:** جميع الحقوق محفوظة لـ **مركز البنيان لتقنية والصناعيات الهندسية — مصراتة**، ليبيا.
- **السنة:**  (`© 2026`).
...
<p align="center">
  <sub>مركز البنيان لتقنية والصناعيات الهندسية — مصراتة — © 2026</sub>
</p>
