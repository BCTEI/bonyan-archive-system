...
> تُزرع هذه البيانات **مرة واحدة فقط** عند أول تشغيل (عندما يكون جدول المستخدمين فارغًا) ولا تُعاد تهيئتها بعد ذلك. إذا غيّر المدير العام كلمة المرور فلن تعمل `admin123` بعد الآن.
...
| الرسالة | السبب | الحل |
|---|---|---|
| `فشل تسجيل الدخول` | اسم المستخدم أو كلمة المرور غير صحيحة | استخدم `admin` / `admin123` إن لم تكن كلمة المرور قد غُيّرت من قبل |
